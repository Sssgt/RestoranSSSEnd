...
if (iconMenu != null) {
    let delay = 500;
    let menuBody = document.querySelector(".header-bottom-menu-left");
    let menuBody2 = document.querySelector(".header-bottom-menu-right");
    let menuBody3 = document.querySelector(".header-top-lang");
